...
\newcommand{\cgfrilp}[1][]{\red[#1]{d}{\ilpg}}
\newcommand{\cgrilp}[1][]{\red[#1]{G}{\ilpg}}
\newcommand{\cstruction}{\struction}
\newcommand{\crstruction}[1][]{\red[#1]{d}{\struction}}
\newcommand{\csatreduce}{\satAndReduce}
\newcommand{\crsatreduce}[1][]{\red[#1]{d}{\satAndReduce}}
\newcommand{\cvcsolver}{\weGotYouCovered}
\newcommand{\crvcsolver}[1][]{\red[#1]{d}{\weGotYouCovered}}
\newcommand{\cbmatching}{\bmatching}
\newcommand{\crbmatching}[1][]{\red[#1]{d}{\bmatching}}
